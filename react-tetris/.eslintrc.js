module.exports = {
  ...
  plugins: ['@typescript-eslint', 'prettier', 'react-hooks', 'react', 'import', 'simple-import-sort', 'unicorn'],
        ...
        'simple-import-sort/imports': [
          'error',
          {
            groups: [
              ...
              ['^(@client/app)(/.*|$)'],
              ['^(@client/modules)(/.*|$)', '^(@screens)(/.*|$)'],
              ['^(@client/components)(/.*|$)'],
              ['^(@shared)(/.*|$)'],
              ['^(@server)(/.*|$)'],
              ['^(@client/hooks)(/.*|$)', '^(@client/utils)(/.*|$)'],
              ['^(@client/styles)(/.*|$)'],
              ['^(@client/ui)(/.*|$)'],
              ['^(@client/i18n)(/.*|$)'],
              ['^\\u0000'],
